...
function calculateSpectrogramDataLength(audio_sample_count, scale) {
...
function generateSpectrogramData(options) {
  ...
  var data_length = calculateSpectrogramDataLength(length, scale);
  ...
  const frameLengthMS = 0.1;
  const frameStepMs = 0.005;
...
export { generateSpectrogramData };